      ...
      renderItem={({ item }) => (
        ...
        >
          <View className="items-center">
            <Text className="text-4xl font-semibold">{getDay(item?.date)}</Text>
            <Image
          ...
          <View className="flex-row justify-between w-full my-2">
            ...
            <View className="gap-2">
              <View className="flex-row gap-2 items-center">
                ...
                <Text className="font-bold text-lg">{item?.astro.sunrise}</Text>
              </View>
              <View className="flex-row gap-2 items-center">
                <Feather name="sunset" size={24} color="black" />
                <Text className="font-bold text-lg">{item?.astro.sunset}</Text>
              </View>
            </View>
            <View className="gap-2">
